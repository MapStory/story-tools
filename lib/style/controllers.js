(function() {
    ...
    module.controller('styleEditorController', ['$scope',
        'styleService', 'styleChoices', 'classificationService', 'ruleStyleService',
        function($scope, styleService, styleChoices, classificationService, ruleStyleService) {
            var styles = {};
            ...
            function classify() {
                ...
                classificationService.classify(
                    ...
                    ruleStyleService.buildRuleStyles(activeStyle);
                });
            }
