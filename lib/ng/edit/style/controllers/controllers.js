    ...
    module.controller('styleEditorController', 
        function($scope, stStyleTypes, stStyleChoices, stLayerClassificationService, stStyleRuleBuilder) {
            ...
            function classify() {
                ...
                // only classify when we have all info
                if (activeStyle.classify.attribute && activeStyle.classify.method && activeStyle.classify.maxClasses &&
                  (activeStyle.classify.colorRamp || activeStyle.classify.colorPalette)) {
            ...
            function setLayer(layer) {
                $scope.layer = layer;
                $scope.styleTypes = stStyleTypes.getTypes(layer.info);
