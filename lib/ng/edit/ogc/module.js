      ...
      return {
        setWMSSource: function(storyLayer) {
          ...
          if (singleTile) {
            ...
            var tileGrid, resolutions = storyLayer.get('resolutions'),
                bbox = storyLayer.get('bbox');
            if (resolutions && bbox) {
