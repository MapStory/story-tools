    ...
    return {
      ...
      link: function (scope, elem) {
        ...
        scope.toggleFullScreen = function () {
          ...
          if (window.parent.document.getElementById('layer_map')) {
            var elem = window.parent.document.getElementById('layer_map'); 
          }
          else if (window.parent.document.getElementById('embedded_map')) {
