(function() {
    ...
    module.provider('stFeatureInfoService', function() {
        ...
        this.$get = function ($rootScope, $q, MapManager, $compile, $http) {
            ...
            May need to do this here rather than in the main module
        ...
        this.show = function (item, position) {
            ...
            if (goog.isDefAndNotNull(position)) {
                ...
                mapService_.getMap().getOverlays().array_[0].setPosition(position);
            }
