(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}(g.storytools || (g.storytools = {})).edit = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
'use strict';
...
exports.SLDStyleConverter = function () {
    return {
        generateStyle: function generateStyle(style, layerName, asString) {
        ...
        createFill: function createFill(style, styleRule) {
            return {
                cssParameter: [{
                    name: 'fill',
        ...
        createStroke: function createStroke(style, styleRule) {
            var dashArray;
        ...
        createPolygonSymbolizer: function createPolygonSymbolizer(style, styleRule) {
        ...
        createPointSymbolizer: function createPointSymbolizer(style, styleRule) {
            var fill = this.createFill(style, styleRule);
            var stroke = this.createStroke(style);
            var graphicOrMark;
            if (style.symbol && style.symbol.graphic) {
                ...
                a.href = style.symbol.graphic + '?' + 'fill=' + encodeURIComponent(styleRule && styleRule.style.symbol.fillColor ? styleRule.style.symbol.fillColor : style.symbol.fillColor) + "&stroke=" + encodeURIComponent(style.stroke.strokeColor);
                graphicOrMark = [{
            ...
            return {
                ...
                value: {
                    graphic: {
                        ...
                        size: {
                            content: [String(styleRule && styleRule.style.symbol && styleRule.style.symbol.size || style.symbol && style.symbol.size || 10)]
                        },
        ...
        createLineSymbolizer: function createLineSymbolizer(style, styleRule) {
            return {
                name: {
        ...
        createTextSymbolizer: function createTextSymbolizer(style) {
            var fontFamily;
        ...
        convertJSON: function convertJSON(style, layerName) {
            var result = {
                name: {
                    namespaceURI: 'http://www.opengis.net/sld',
            ...
            var rule,
                ruleContainer = result.value.namedLayerOrUserLayer[0].namedStyleOrUserStyle[0].featureTypeStyle[0].rule;
            if (style.rules) {
...
exports.StyleComplete = function () {
    return {
        isComplete: function isComplete(style) {
            if (style === undefined) {
                return false;
            }
...
exports.WFSDescribeFeatureType = function () {
    ...
    this.parseResult = function (xml) {
        if (!this.context) {
            this.context = new owsjs.Jsonix.Context([owsjs.mappings.XSD_1_0]);
...
exports.WPSClassify = function () {
    ...
    this.createContext = function () {
        this.context = new owsjs.Jsonix.Context([owsjs.mappings.XLink_1_0, owsjs.mappings.OWS_1_1_0, owsjs.mappings.Filter_1_1_0, owsjs.mappings.OWS_1_0_0, owsjs.mappings.SMIL_2_0, owsjs.mappings.SMIL_2_0_Language, owsjs.mappings.GML_3_1_1, owsjs.mappings.WFS_1_1_0, owsjs.mappings.WPS_1_0_0], {
            namespacePrefixes: {
                'http://www.w3.org/1999/xlink': 'xlink',
