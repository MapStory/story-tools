...
(function() {
  ...
  module.directive("graphicEditor", ["stStyleChoices", "ol3MarkRenderer", "iconCommons", "iconCommonsSearch", "$uibModal", "stSvgIcon", function(
    stStyleChoices,
    ol3MarkRenderer,
    iconCommons,
    iconCommonsSearch,
...
(function() {
  ...
  module.factory("iconCommonsSearch", ["$http", "$uibModal", "$injector", function($http, $uibModal, $injector) {
    var iconCommonsHost = $injector.has("iconCommonsHost")
      ? $injector.get("iconCommonsHost")
      : "http://localhost:8000";
  ...
  module.controller("iconCommonsController", ["$scope", "iconCommonsSearch", "stRecentChoices", function(
    $scope,
    iconCommonsSearch,
    stRecentChoices
  ) {
...
(function() {
  ...
  module.factory("stLayerClassificationService", ["$q", "$http", "$uibModal", "$sce", "$log", function(
    $q,
    $http,
    $uibModal,
    $sce,
